...
public class imt2022570_librarydb {
   ...
   static String sortBooks(String baseSql, Scanner scan) {
      ...
      switch (sortChoice) {
         case 1:
            orderBy = " ORDER BY book_id";
            break;
         case 2:
            orderBy = " ORDER BY book_name";
            break;
         case 3:
            orderBy = " ORDER BY author_name";
            break;
         case 4:
            orderBy = " ORDER BY publication_year";
            break;
         case 5:
            orderBy = " ORDER BY num_copies";
            break;
         default:
   ...
   static void add_book(Statement stmt, Scanner scan, Connection conn) {
      try {
         ...
         String sql = String.format(
               "INSERT INTO Book (book_name, publication_year, num_copies, author_name) VALUES('%s', '%d', '%d', '%s');",
               name, year, num_copies, author);
         int result = updateSqlStmt(stmt, sql, conn);
